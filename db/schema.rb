...
ActiveRecord::Schema[7.1].define(version: 2023_11_15_122655) do
  ...
  create_table "note_relations", force: :cascade do |t|
    t.uuid "parent_note_id"
    t.uuid "child_note_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["child_note_id"], name: "index_note_relations_on_child_note_id"
    t.index ["parent_note_id"], name: "index_note_relations_on_parent_note_id"
  end
